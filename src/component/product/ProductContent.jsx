...
const ProductContent = ({ searchQuery }) => {
  ...
  const handleCategoryClick = (categories) => {
    console.log("Categories clicked:", categories);
    ...
    categories.forEach((category) => {
      const boxContentRef = boxContentRefs.current[category];
      if (boxContentRef) {
        boxContentRef.classList.toggle("active");
      }
    });
  };
              ...
              <div className="scrolling-boxes-wrapper">
                ...
                >
                  <div
                    ...
                    ref={(ref) => (boxContentRefs.current["fruit flakes"] = ref)}
                    onClick={() =>
                      handleCategoryClick(["fruit flakes", "fruit powder"])
                    }
                  >
                  ...
                  <div
                    className="box_content"
                    ref={(ref) => (boxContentRefs.current["vegetable flakes"] = ref)}
                    onClick={() =>
                      handleCategoryClick([
                        "vegetable flakes",
                        "vegetable powder",
                  ...
                  <div
                    className="box_content"
                    ref={(ref) => (boxContentRefs.current["leaf flakes"] = ref)}
                    onClick={() =>
                      handleCategoryClick(["leaf flakes", "leaf powder"])
                    }
                  >
                  ...
                  <div
                    className="box_content"
                    ref={(ref) => (boxContentRefs.current["rose"] = ref)}
...
.scrolling-boxes {
  display: flex;
  padding: 10px 0;
  animation: scroll 15s linear infinite; /* Endless scrolling animation */
}
